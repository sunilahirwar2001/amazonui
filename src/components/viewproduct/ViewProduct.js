    ...
    <section className="flex flex-col justify-center items-center p-4 bg-gray-100">
      <section className="w-full max-w-xl bg-white p-4 rounded-lg shadow-md">
        ...
        <section className="flex flex-col items-center mb-4">
          <h2 className="text-2xl font-bold">Rs: {data?.price}</h2>
          <span className="text-gray-500 text-sm">Rs4000</span>
          <span className="text-green-500 text-sm">{Math.ceil(Math.random() * 100)}% Off</span>
        </section>
        <section className="flex items-center justify-center mb-4">
          <span className="text-yellow-500 text-xl mr-2">{data?.rating?.rate}</span>
          <i className="fas fa-star text-yellow-500"></i>
          <span className="text-gray-500 ml-2">23 ratings and 123 reviews</span>
          <img
        ...
        <h3 className="text-lg font-bold">Available Offers</h3>
        <section className="mb-4">
          <p className="flex items-center mb-2">
            <img
              ...
              alt=""
            />
            Special Price Get extra 48% off (price inclusive of cashback/coupon)
          </p>
        ...
        <section className="w-full mb-4">
          <div className="flex items-center">
            ...
            />
            <button className="ml-2 px-4 py-2 bg-blue-600 text-white rounded-md">Check</button>
          </div>
        </section>
        <section className="text-center text-gray-500 text-sm mb-4">
          Delivery by 26 Jan, Thursday if ordered today
        </section>
        </section>
