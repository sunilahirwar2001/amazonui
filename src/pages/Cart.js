...
import { decrementQuantity, deleteItem, incrementQuantity,} from '../redux/amazonSlice';
const Cart = () => {
 ...
 active: from bg-red-400 active:to-red-500 duration-200 py-1 rounded-md mt-3'>Delete</button>
                </div>
              </div>
            ))}
          </div>
